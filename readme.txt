...
<ul>
	<li>bubblewidth (integer, in pixels) - Sets the max width for tooltip bubble. If you are trying to fit an image inside the bubble, <span style="color: #222222;">and the image is too big for the tooltip bubble area, try adjusting the max bubble width to make sure it is big enough to the fit the desired image.</span></li>
...
= 2.0 =
New: The new version allows you to click a tooltip button on the visual editor to easily add tooltips. Also, you can easily add images, links and more inside the tooltips and as tooltip triggers. You can now customize individual tooltips.